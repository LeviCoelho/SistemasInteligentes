...
X_Iris = dataset_Iris.iloc[0:101, 0:4].values # o iloc gera uma subtabela ":" todas as linhas, da coluna 0 a 3, o ultimo numero não está incluso
np.random.shuffle(X_Iris)

D_Iris = dataset_Iris.iloc[0:101, 4:].values
np.random.shuffle(D_Iris)

X_IrisTest = dataset_Iris.iloc[101:151, 0:4].values # o iloc gera uma subtabela ":" todas as linhas, da coluna 0 a 3, o ultimo numero não está incluso
np.random.shuffle(X_IrisTest)
D_IrisTest = dataset_Iris.iloc[101:151:, 4:].values
